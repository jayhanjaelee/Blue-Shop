...
<div class="products-container m0auto">
  ...
  <div class="products__filter-container">
    <span class="products__count">총 <?= $count->products_count ?>건</span>
  ...
  <div class="products-list-container">
    ...
    <div class="products-item">
      <a href="/product/<?= $product->id ?>?query=<?= $query ?>"><img class="products-item__image"
          src="<?= "/static/imgs/products/{$categories[$product->category_id]}/" . $product->image ?>"
          alt="<?= $product->name ?>"></a>
