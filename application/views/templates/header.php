      ...
      <div class="header-middle">
        ...
        <div class="header-middle__search-form-container">
          <form action="/search" method="GET">
            ...
            <button type="submit">
              <svg xmlns="http://www.w3.org/2000/svg" width="2.2rem" height="2.2rem" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
        ...
        <div class="header-middle__order">
          <div class="header-middle__order-list">
            <button type="button" class="header-middle__order-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="2.8rem" height="2.8rem" fill="currentColor" class="header-middle__order-item-icon bi bi-heart" viewBox="0 0 16 16">
            ...
            <button type="button" class="header-middle__order-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="2.8rem" height="2.8rem" fill="currentColor" class="header-middle__order-item-icon bi bi-cart" viewBox="0 0 16 16">
        ...
        <ul class="header-bottom__list">
          <li>
            <div class="header-bottom__category-container">
              <svg xmlns="http://www.w3.org/2000/svg" width="1.6rem" height="1.6rem" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
