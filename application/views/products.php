...
<div class="products-container m0auto">
  <h1 class="products__header"><?= $ko_categories[$category] ?></h1>
  ...
  <div class="products-list-container">
    ...
    ?>
      <div class="products-item">
        <a href="/product/<?= $product['id'] ?>?category=<?= $category ?>"><img class="products-item__image" src="<?= $img_dir . $product['image'] ?>" alt=""></a>
